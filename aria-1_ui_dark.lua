...
stroke.Color = Color3.fromRGB(49, 45, 67)
stroke.Thickness = 1
stroke.Parent = main
...
sidebar.BackgroundColor3 = Color3.fromRGB(18, 17, 29)
sidebar.BorderSizePixel = 0
sidebar.Parent = body

local sidebarStroke = Instance.new("UIStroke")
sidebarStroke.Color = Color3.fromRGB(45, 42, 62)
...
local function makeTabButton(text, order)
    ...
    b.BackgroundColor3 = Color3.fromRGB(23, 22, 34)
    b.BorderSizePixel = 0
    b.Text = text
    b.TextSize = 12
...
local function makeCard(parent, icon, name, desc, order)
    ...
    card.BackgroundColor3 = Color3.fromRGB(23, 22, 34)
    ...
    s.Color = Color3.fromRGB(51, 47, 70)
    s.Thickness = 1
    s.Parent = card
    ...
    ic.TextColor3 = Color3.fromRGB(164, 111, 255)
    ic.Parent = card
    ...
    nm.Text = name
    nm.TextSize = 13
    nm.TextColor3 = Color3.fromRGB(236,236,245)
    ...
    ds.Text = desc
    ds.TextSize = 11
    ds.TextColor3 = Color3.fromRGB(155,150,175)

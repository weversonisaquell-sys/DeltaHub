...
main.Name = "Window"
main.Size = UDim2.fromOffset(640, 520)
...
htmlStatus.Size = UDim2.new(1, 0, 0, 30)
htmlStatus.BackgroundColor3 = Color3.fromRGB(23, 18, 32)
...
htmlStatusText.Position = UDim2.fromOffset(16, 0)
htmlStatusText.Size = UDim2.new(1, -32, 1, 0)
htmlStatusText.Font = Enum.Font.Gotham
htmlStatusText.TextSize = 12
htmlStatusText.TextColor3 = Color3.fromRGB(168, 159, 189)
...
stroke.Color = Color3.fromRGB(42, 34, 51)
stroke.Thickness = 1
stroke.Parent = main

local titleBar = Instance.new("Frame")
titleBar.Size = UDim2.new(1, 0, 0, 46)
titleBar.BackgroundColor3 = Color3.fromRGB(23, 18, 32)
...
pages.Position = UDim2.new(0, 64, 0, 0)
pages.Size = UDim2.new(1, -64, 1, 0)
...
local function makePage(name)
    ...
    frame.BackgroundColor3 = Color3.fromRGB(10, 7, 16)
    frame.Visible = false
    frame.Parent = pages
...
local function makeTabButton(text, order)
    ...
    b.BackgroundColor3 = Color3.fromRGB(20, 16, 25)
    b.BorderSizePixel = 0
    b.Text = text
    b.TextSize = 12
...
local function makeCard(parent, icon, name, desc, order)
    ...
    card.BackgroundColor3 = Color3.fromRGB(20, 16, 25)
    ...
    s.Color = Color3.fromRGB(42, 34, 51)
    s.Thickness = 1
    s.Parent = card
